...
class MainActivity : AppCompatActivity() {
    private val videos: Array<Array<String>> = arrayOf(
        arrayOf("RED&PINK FLOWER BASKET MAKING, FLORIST, FLOWER LESSON, KOREAN FLORIST", "AQUkIuLK7P4"),
        arrayOf("Handtied and Wrapping", "j_W8JcXGAZI"),
        arrayOf("Tulip Bouquet Wrapping Techniques", "K8FRnZ5nAMw"),
        arrayOf("purple flowers arrangement", "LTBBLdLeYV0"),
        arrayOf("Tulip Handtied/ Wrapping", "-BsBkNF3oGU"),
        arrayOf("Asymmetric flower arrangement", "0O17Fs1P7OA"),
        arrayOf("Flower Box / 2 Style", "9kRdF8J4xcw"))
    ...
    private fun initializeRV(){
        ...
        recyclerView.adapter = VidAdapter(videos, player)
